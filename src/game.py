...
p1_weapon = pygame.image.load(r"C:\Users\kcheng\Documents\GitHub\final-project-circle_wars-py\src\img\scythe.png")
...
while p1_dead == False:
    ...
    win.blit(pygame.transform.scale(p1_sprite, (p1.x_diameter, p1.y_diameter)), (p1.x_pos, p1.y_pos))
    win.blit(pygame.transform.scale(p1_weapon, (p1.x_diameter/2, p1.y_diameter)), (p1_weapon_x, p1.y_pos))

    font = pygame.font.SysFont("Times New Roman", screen_width/10)
